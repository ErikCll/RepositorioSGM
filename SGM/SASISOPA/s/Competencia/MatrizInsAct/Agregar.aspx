<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Agregar.aspx.cs" Inherits="SASISOPA.s.Competencia.MatrizInsAct.Agregar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      Agregar censo de actividad
</asp:Content>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                              <div class="form-group float-right">
                                <asp:Button runat="server" CssClass="btn btn-primary" Text="Guardar" ID="btnGuardar" OnClick="btnGuardar_Click" Visible="false"/>
                                  <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/Competencia/MatrizInsAct/Index.aspx" />
                            </div>
                        </div>
