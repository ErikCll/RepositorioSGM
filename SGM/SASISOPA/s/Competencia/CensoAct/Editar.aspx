<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="SASISOPA.Competencia.CensoAct.Editar" %>
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12"></div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" id="btnRegresar" Text="Regresar" CssClass="btn btn-default" PostBackUrl="~/s/Competencia/CensoAct/Index.aspx" />
                            </div>
                        </div>
                    </div>
                      </div>
