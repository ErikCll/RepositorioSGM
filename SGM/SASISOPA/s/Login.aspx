<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SASISOPA.s.Login" %>
...
<head >
  ...
  <title>SASISOPA | Iniciar sesión</title>
...
<%--                <div class="col-sm-1 col-md-1 col-lg-1"></div>--%>
                <div class="col-sm-6 col-md-6 col-lg-6 justify-content-center mt-5" >
                    <h1 class="text-center font-weight-bold">SASISOPA</h1>
                    <h2 class="text-center ocultar-letras"> Sistema de Administración de Seguridad Industrial, Seguridad Operativa y Protección al Medio Ambiente</h2>
