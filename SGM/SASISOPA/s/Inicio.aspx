...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <div class="custom-control-inline"> Inicio <a class="nav-link text-sm " data-widget="control-sidebar" data-slide="true" href="#" role="button">
          Opciones
        </a></div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    ...
    <aside class="control-sidebar control-sidebar-dark h-25 " style="top: 61px; display: block;">
