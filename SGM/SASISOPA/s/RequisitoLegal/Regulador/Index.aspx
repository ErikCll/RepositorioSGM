<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SASISOPA.s.RequisitoLegal.Regulador.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
    ...
    <li class="breadcrumb-item "><a>Regulador</a></li>
</asp:Content>
                    ...
                    <div class="card-body">
                        <div class="row">
                              <div class="col-sm-4 col-md-4 col-lg-8">
                                     <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/s/RequisitoLegal/Regulador/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
                                  </div>
                                 ...
                                 CssClass=" table table-bordered table-striped table-sm"
                                   ...
                                   id="gridRegulador"
                                    ...
                                    AutoGenerateColumns="false"
                                     ...
                                     EmptyDataText="Sin registro de reguladores."
                                     PageSize="10"
                                     OnPageIndexChanging="gridRegulador_PageIndexChanging"
                                     AllowPaging="true"
                                 DataKeyNames="Id_Regulador"
                                    ...
                                    <Columns>
                                      <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="260px" ItemStyle-Width="260px" ControlStyle-Width="76px">
                                        ...
                                        <asp:BoundField HeaderText="Nombre corto" DataField="NombreCorto" HeaderStyle-HorizontalAlign="Center" />
