<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SASISOPA.s.RequisitoLegal.DocRegulador.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
    ...
    <li class="breadcrumb-item "><a>Documento Regulador</a></li>
</asp:Content>
                    ...
                    <div class="card-body">
                        <div class="row">
                              <div class="col-sm-4 col-md-4 col-lg-8">
                                     <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/s/RequisitoLegal/DocRegulador/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
                                  </div>
