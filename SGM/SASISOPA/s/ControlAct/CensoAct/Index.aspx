    <%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SASISOPA.s.ControlAct.CensoAct.Index" %>
                    ...
                    <div class="card-body">
                        <div class="row">
                              <div class="col-sm-4 col-md-4 col-lg-8">
                                     <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/s/ControlAct/CensoAct/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
                                  </div>
