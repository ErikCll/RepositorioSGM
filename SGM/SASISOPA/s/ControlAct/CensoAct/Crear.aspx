<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="SASISOPA.s.ControlAct.CensoAct.Crear" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/ControlAct/CensoAct/Index.aspx" />
                            </div>
                        </div>
                        </div>
                    </div>
