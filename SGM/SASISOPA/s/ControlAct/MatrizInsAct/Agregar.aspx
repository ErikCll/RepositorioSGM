<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Agregar.aspx.cs" Inherits="SASISOPA.s.ControlAct.MatrizInsAct.Agregar" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group float-right">
                                            ...
                                            <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/ControlAct/MatrizInsAct/Index.aspx" />
                                        </div>
                                    </div>
