<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SASISOPA.FuncionRes.MatrizCatAct.Consulta" %>
                                ...
                                <div class=" table-responsive">
                                    <div style="overflow: auto; height: auto">
                                     ...
                                     HeaderStyle-CssClass=" text-white"
                                        ...
                                        <asp:Button runat="server" CssClass="btn btn-default" ID="btnRegresar" PostBackUrl="~/s/FuncionRes/Inicio.aspx" Text="Regresar" />
                                    </div>
                                </div>
                            </div>
                        </div>
