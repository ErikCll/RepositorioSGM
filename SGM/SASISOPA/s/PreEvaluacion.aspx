<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreEvaluacion.aspx.cs" Inherits="SASISOPA.s.PreEvaluacion" %>
...
<body class=" bg-light ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-122 col-md-12 col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <asp:Button runat="server" ID="btnValidar2" OnClick="btnValidar2_Click" Visible="false" />
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <telerik:RadWindow ID="RadWindow1" runat="server" Behaviors="Close,Resize,Maximize" InitialBehaviors="Maximize" Height="600px" Width="1200px" Modal="true" VisibleStatusbar="false" VisibleOnPageLoad="false">
                                    </telerik:RadWindow>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
       ...
       document.getElementById("<%=btnValidar2.ClientID%>").click();
