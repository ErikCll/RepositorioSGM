<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="SASISOPA.s.Seguridad.Inicio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    12. Seguridad para Contratistas
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
    ...
    <li class="breadcrumb-item "><a>12. Seguridad para Contratistas</a></li>
</asp:Content>
