<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="s_Login" %>
...
<head >
  ...
  <title>Secretario | Iniciar sesión</title>
...
<%--                <div class="col-sm-1 col-md-1 col-lg-1"></div>--%>
                <div class="col-sm-6 col-md-6 col-lg-6 justify-content-center mt-5" >
                    <h1 class="text-center font-weight-bold">Secretario</h1>
                    <h2 class="text-center ocultar-letras"> </h2>
