<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Operacion.s.Produccion.Material.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
      <li class="breadcrumb-item active"><asp:LinkButton runat="server" OnClick="IrSAM">SAM</asp:LinkButton></li>
                  <li class="breadcrumb-item "><a href="../../Inicio.aspx">Operación (Inicio)</a></li>
                     ...
                     <li class="breadcrumb-item "><a>Material producido</a></li>
</asp:Content>
             ...
             <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-3">
                        ...
                        <div class="fomr-group">
                            <label>Equipo:</label>
                            <asp:DropDownList runat="server" CssClass="form-control" AutoPostBack="true" ID="ddl_Equipo"  DataValueField="Id_Equipo" DataTextField="Nombre" OnSelectedIndexChanged="ddl_Equipo_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
              ...
              <!-- /.card-footer -->
                        ...
                        <br />
                         <div class="card">
              <div class="card-header">
                <h5 class="card-title font-weight-bold">Gráfica y resumen mensual de material producido</h5>
...
<div class="card card-default">
              ...
              <div class="card-body" style="display: block;">
                  <div class="row">
                           <div class="col-sm-12 col-md-12 col-lg-12">
                <h3><asp:Label runat="server" ID="lblTurno1"></asp:Label> <label class="font-weight-normal text-lg"> Mts.</label><i class="fas fa-fw fa-tachometer-alt fa-2x text-black-50 float-right"></i>
</h3>
...
<div class="card card-default">
              ...
              <div class="card-body" style="display: block;">
                  <div class="row">
                           <div class="col-sm-12 col-md-12 col-lg-12">
                <h3><asp:Label runat="server" ID="lblTurno2"></asp:Label> <label class="font-weight-normal text-lg"> Mts.</label><i class="fas fa-fw fa-tachometer-alt fa-2x text-black-50 float-right"></i>
</h3>
...
<div class="card card-default">
              ...
              <div class="card-body" style="display: block;">
                  <div class="row">
                           <div class="col-sm-12 col-md-12 col-lg-12">
                <h3><asp:Label runat="server" ID="lblTurno3"></asp:Label> <label class="font-weight-normal text-lg"> Mts.</label><i class="fas fa-fw fa-tachometer-alt fa-2x text-black-50 float-right"></i>
</h3>
