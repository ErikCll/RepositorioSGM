<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Operacion.s.Catalogo.Equipo.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
      <li class="breadcrumb-item active"><asp:LinkButton runat="server" OnClick="IrSAM">SAM</asp:LinkButton></li>
                  <li class="breadcrumb-item "><a href="../../Inicio.aspx">Operación</a></li>
                     <li class="breadcrumb-item "><a>Equipo</a></li>
</asp:Content>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                           <div class="col-sm-4 col-md-4 col-lg-8">
                                                           <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/s/Catalogo/Equipo/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
