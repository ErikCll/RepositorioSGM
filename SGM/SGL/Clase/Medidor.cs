...
namespace SGL.Clase
{
    public class Medidor
    {
        ...
        public DataTable Mostrar(string txtSearch, int IdSuscripcion)
        {
            ...
            string query = "SELECT Id_Medidor,Nombre, VariableMedir, PeriodoCalibracion, PeriodoVerificacion FROM Cat_Medidor WHERE Activado IS NULL AND Id_Suscripcion=@IdSuscripcion AND TipoSistema='SGL' ORDER BY Id_Medidor DESC";
            if (!String.IsNullOrEmpty(txtSearch.Trim()))
            {
                query = "SELECT Id_Medidor,Nombre, VariableMedir, PeriodoCalibracion, PeriodoVerificacion FROM Cat_Medidor WHERE Activado IS NULL AND Id_Suscripcion=@IdSuscripcion AND Nombre LIKE '%'+@txtSearch+'%' AND TipoSistema='SGL' ORDER BY Id_Medidor DESC ";
            }
        ...
        {
            comm.Connection = conexion.AbrirConexion();
            comm.CommandText = "INSERT INTO [Cat_Medidor] (Nombre,VariableMedir,PeriodoCalibracion,PeriodoVerificacion,Id_Suscripcion,TipoSistema) VALUES(@Nombre,@VariableMedir,@PeriodoCalibracion,@PeriodoVerificacion,@IdSuscripcionn,'SGL')";
            comm.CommandType = CommandType.Text;
