<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SGL.s.Confirmacion.Variable.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    Variables físicas (Magnitud)
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
      <li class="breadcrumb-item active"><asp:LinkButton runat="server" OnClick="IrSAM">SAM</asp:LinkButton></li>
                  <li class="breadcrumb-item "><a href="../../Inicio.aspx">SGL (Inicio)</a></li>
                     ...
                     <li class="breadcrumb-item "><a>Variables físicas (Magnitud)</a></li>
</asp:Content>
