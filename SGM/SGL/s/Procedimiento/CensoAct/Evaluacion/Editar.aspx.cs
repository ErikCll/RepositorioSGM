...
namespace SGL.s.Procedimiento.CensoAct.Evaluacion
{
    public partial class Editar : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/s/Procedimiento/CensoAct/Control/Index.aspx?id=" + Request.QueryString["act"] + "");
        }

        protected void Regresar2(Object sender, EventArgs e)
        {
            Response.Redirect("~/s/Procedimiento/CensoAct/Evaluacion/Crear.aspx?id=" + Request.QueryString["ctr"] + "&act=" + Request.QueryString["act"] + "");
        }
