<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Agregar.aspx.cs" Inherits="SGL.s.Procedimiento.MatrizCatAct.Agregar" %>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                              <div class="form-group float-right">
                                <asp:Button runat="server" CssClass="btn btn-primary" Text="Guardar" ID="btnGuardar" OnClick="btnGuardar_Click"/>
                                  <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/Procedimiento/MatrizCatAct/Detalle.aspx" />
                            </div>
                        </div>
