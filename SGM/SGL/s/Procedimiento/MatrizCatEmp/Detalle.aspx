<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Detalle.aspx.cs" Inherits="SGL.s.Procedimiento.MatrizCatEmp.Detalle" %>
...
<asp:Button ID="btnBuscar" Text="Buscar" runat="server"  OnClick="Buscar"  CssClass="btn btn-default btn-sm" />
                     ...
                     <div class=" table-responsive">
                            <div style="overflow:auto ;height:auto">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/Procedimiento/MatrizCatEmp/Index.aspx" />
