<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="SGL.s.Acreditacion.EMA.Editar" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="form-group">
                                <label>No:</label>
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtNo" onkeypress="return AllowAlphabet(event)" MaxLength="200"></asp:TextBox>
                                  <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtNo"
                                    ErrorMessage="No requerido." ForeColor="Red" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" CssClass="btn btn-default" Text="Regresar" PostBackUrl="~/s/Acreditacion/EMA/Index.aspx" />
                            </div>
                        </div>
                        </div>
                    </div>
