<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SGM.Instalacion.Index" %>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="container col-12">
                       ...
                       <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/Instalacion/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
