<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Detalle.aspx.cs" Inherits="SGM.Competencia.Programa.Detalle" %>
...
<asp:Button ID="btnBuscar" Text="Buscar" runat="server"  OnClick="Buscar"  CssClass="btn btn-default btn-sm" />
                        ...
                        <div class=" table-responsive">
                            <div style="overflow:auto ;height:auto">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" Text="Regresar" CssClass="btn btn-default" PostBackUrl="~/Competencia/Programa/Index.aspx" />
