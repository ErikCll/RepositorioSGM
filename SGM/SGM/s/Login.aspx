                                ...
                                <asp:Login runat="server" CssClass="col-12" ID="Login1">
                                    <LayoutTemplate>
                                        <div class="card-body">
                                            ...
                                            <asp:Button runat="server" class="btn btn-primary float-right my-2" ID="LoginButton" Text="Entrar" ValidationGroup="LoginButton" CommandName="Login" OnClick="LoginButton_Click" />
