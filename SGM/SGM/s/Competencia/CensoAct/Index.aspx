<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SGM.Competencia.CensoAct.Index" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Archivo" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HyperLink runat="server" ImageUrl="~/dist/img/pdficon.svg" ImageHeight="17px" ImageWidth="17px" ID="lnkArchivo" Target="_blank"></asp:HyperLink>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
