...
<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Agregar.aspx.cs" Inherits="SGM.Competencia.Programa.Agregar" %>
                                ...
                                <asp:Button runat="server" PostBackUrl="~/s/Competencia/Programa/Detalle.aspx" CssClass="btn btn-default" ID="btnRegresar2" Text="Regresar" />
                                          ...
                                          <div class="col-sm-4 col-md-4 col-lg-8">
                                              ...
                                              <label>Url para ingresar a la evaluación: </label> <asp:HyperLink runat="server"
                                                  Text="http://orygon.azurewebsites.net/SGM/s/PreEvaluacion.aspx" NavigateUrl="http://orygon.azurewebsites.net/SGM/s/PreEvaluacion.aspx" Target="_blank"></asp:HyperLink>
                                </div>
