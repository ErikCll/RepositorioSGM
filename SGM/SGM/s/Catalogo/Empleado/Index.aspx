<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SGM.Catalogo.Empleado.Index" %>
               ...
               <div class="col-lg-12">
                <div class="row">
                    <div class="container col-12">
                       ...
                       <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/s/Catalogo/Empleado/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
