<%@ Page Title="" Language="C#" MasterPageFile="~/s/Site1.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="SGM.s.Catalogo.Inicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
    ...
    <li class="breadcrumb-item "><a>Catálogo</a></li>
</asp:Content>
        ...
        <div class="row">
                ...
                <div class="card card-default shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">Medidores </h3>
