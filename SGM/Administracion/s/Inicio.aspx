...
<div class="card card-default shadow-sm">
              ...
              <div class="card-body" style="display: block;">
                ...
                <h3><asp:Label runat="server" ID="lblPorcentaje" Text="83"></asp:Label><label class="font-weight-normal">%</label><i class="fas fa-fw fa-tachometer-alt fa-2x text-black-50 float-right"></i>
</h3>
