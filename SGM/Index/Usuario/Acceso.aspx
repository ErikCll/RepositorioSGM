<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Acceso.aspx.cs" Inherits="SAM.Usuario.Acceso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mapeo" runat="server">
    ...
    <li class="breadcrumb-item "><a>Agregar Accesos</a></li>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12"></div>
                                <div class="col-sm-3 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        <label>Sistema:</label>
                                                                        <asp:DropDownList runat="server" ID="ddl_Sistema" CssClass="form-control" DataTextField="Nombre" DataValueField="Id_Sistema" AutoPostBack="true" OnSelectedIndexChanged="ddl_Sistema_SelectedIndexChanged"></asp:DropDownList>
                              ...
                              <div class="col-sm-3 col-md-3 col-lg-3">
                                  <div class="form-group">
                                      <label>Menú</label>
                                         <asp:DropDownList runat="server" ID="ddl_Menu" CssClass="form-control" DataTextField="Nombre" DataValueField="Id_Menu" AutoPostBack="true" OnSelectedIndexChanged="ddl_Menu_SelectedIndexChanged"></asp:DropDownList>
                                    <asp:RequiredFieldValidator runat="server" ID="reqInstalacion" ControlToValidate="ddl_Menu"
                                    ErrorMessage="Menu requerido." ForeColor="Red" InitialValue="0" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                                  </div>
                                ...
                                <div class="table-responsive">
                                    <div style="overflow: auto; height: 400px">
                                        <asp:GridView ID="gridAcceso" runat="server"
                                            ...
                                            EmptyDataText="Sin registro de accesos."
                                            DataKeyNames="Id_SubMenu"
                                            HeaderStyle-HorizontalAlign="Center"
                                             OnRowDataBound="gridAcceso_RowDataBound"
                                             >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Accesos" DataField="Accesos"  />

                                                <asp:TemplateField Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIdSubMenu" runat="server" Text='<%#Eval("Id_SubMenu") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                         <asp:TemplateField Visible="false">
                                                                    <ItemTemplate>
    ...
    <script type="text/javascript">
               ...
               function SelectAll(id)
        {
            ...
            var grid = document.getElementById("<%= gridAcceso.ClientID %>");
