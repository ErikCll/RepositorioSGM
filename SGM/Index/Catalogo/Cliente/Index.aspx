<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SAM.Catalogo.Cliente.Index" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 col-lg-8">
                                        <asp:LinkButton runat="server" CssClass="text-sm" PostBackUrl="~/Catalogo/Cliente/Crear.aspx"><span class=" ion-plus" ></span>Agregar</asp:LinkButton>
                                        ...
                                        <div class=" table-responsive ">
                                            <div style="overflow: auto; height: auto">
                                                <asp:GridView runat="server"
                                                    ...
                                                    EmptyDataText="Sin registro de clientes."
                                                    PageSize="10"
