<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="SAM.Catalogo.Cliente.Crear" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" PostBackUrl="~/Catalogo/Cliente/Index.aspx" class="btn btn-default" Text="Regresar"/>
                            </div>
                        </div>
                        </div>
                    </div>
