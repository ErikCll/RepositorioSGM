<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="SAM.Catalogo.Empleado.Crear" %>
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <%--             <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtNoEmpleado"
                                    ErrorMessage="No. de empleado requerido." ForeColor="Red" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>--%>
                            </div>
                            <div class="form-group">
                                <label>Nombre:</label>
