<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="Index.Catalogo.Area.Crear" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" ID="btnRegresar" PostBackUrl="~/Catalogo/Area/Index.aspx" class="btn btn-default" Text="Regresar"/>
                            </div>
                        </div>
                        </div>
                    </div>
