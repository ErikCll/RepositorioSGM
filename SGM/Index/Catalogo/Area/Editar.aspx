<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="Index.Catalogo.Area.Editar" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:Button runat="server" CssClass="btn btn-default" PostBackUrl="~/Catalogo/Area/Index.aspx" ID="btnRegresar" Text="Regresar" />
                            </div>
                        </div>
                    </div>
                      </div>
